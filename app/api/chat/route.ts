    ...
    const result = streamText({
      ...
      tools: {
        ...
        show_market_dashboard: tool({
          ...
          inputSchema: zodSchema(marketDashboardSchema),
          execute: async ({ symbols, lookback }: z.infer<typeof marketDashboardSchema>) => {
            const results: Array<{
              symbol: string
        ...
        analyze_options_chain: tool({
          ...
          inputSchema: zodSchema(optionsChainSchema),
          execute: async ({ symbol }: z.infer<typeof optionsChainSchema>) => {
        ...
        show_price_chart: tool({
          ...
          inputSchema: zodSchema(priceChartSchema),
          execute: async ({ symbol, timeframe }: z.infer<typeof priceChartSchema>) => {
